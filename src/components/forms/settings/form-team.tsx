    ...
    <FormCard>
      ...
      {isAdmin && (
        <>
          ...
          {/* ── Direct credential creation (admin only) ──────────────────── */}
          <FormCardHeader>
            <FormCardTitle>Create user directly</FormCardTitle>
            <FormCardDescription>
              Set the email and password yourself. Share the credentials with
              the employee — they can change their password after first sign-in.
            </FormCardDescription>
          </FormCardHeader>
          <FormCardContent>
            <Form {...directForm}>
