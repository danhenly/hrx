...
You can **deploy our probes** on your own VPC, [Cloudflare Containers](https://docs.openstatus.dev/guides/how-to-deploy-probes-cloudflare-containers/) and more. It is **8.5MB small** and fits even on a [Raspberry Pi 3](/landing/blog) with ease. Read more [in the docs](https://docs.openstatus.dev/tutorial/how-to-create-private-location/).
